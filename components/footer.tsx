    ...
    <footer className="relative bg-gray-50 dark:bg-slate-900/50 pt-16 pb-8 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div>
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  sajjadmatinm@gmail.com
                </a>
                <p className="inline-flex items-center gap-2 text-blue-600 dark:text-blue-400 font-medium hover:underline">+93744217212</p>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 dark:border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          >
            © {currentYear} Sajjad Matin. All rights reserved.
          </motion.p>
